...
BsdfSample Bsdf::sample(const Vec3& wP, const Vec3& wi, const Vec3& normal, const float eta_i, const float eta_t) const
{
...
BsdfSample Bsdf::sampleSpecular(const Vec3& wP, const Vec3& wi, const Vec3& normal, const float ior, const float fresnel) const
{
    BsdfSample sample;
...
BsdfSample Bsdf::sampleTransmission(const Vec3& wP, const Vec3& wo, const float ior, const float fresnel) const
{
    BsdfSample sample;
...
BsdfSample Bsdf::sampleDiffuse(const Vec3& wP, const Vec3& wi, const Vec3& normal, const float ior) const
{
    BsdfSample sample;
